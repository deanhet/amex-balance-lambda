    ...
    getAccounts() {
        ...
        return fetch(`${baseURI}/myca/intl/moblclient/emea/ws.do?Face=en_GB`, options)
            ...
            .then(text => {
                ...
                const balance = xpath.select("/XMLResponse/CardAccounts/CardAccount/AccountSummaryData/SummaryElement[@name='availableCredit']/@value", XML).toString();
